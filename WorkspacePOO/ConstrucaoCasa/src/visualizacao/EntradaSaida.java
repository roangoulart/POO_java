...
public class EntradaSaida {
	...
	public static int solicitaOpcao1() {
	...
	public static String solicitaEstado(String tipoAbertura) {
		...
		return JOptionPane.showOptionDialog(null, "Informe o estado da " + tipoAbertura, "Estado",
				JOptionPane.DEFAULT_OPTION, JOptionPane.INFORMATION_MESSAGE, null, opcoes, opcoes[]));
		// opcoes[0] significa "fechada" e opcoes[1] significa "aberta"
	}
